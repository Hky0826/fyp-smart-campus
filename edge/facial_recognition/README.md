...
The script first runs `python3 -m edge.facial_recognition.src.hailo.diagnostics`. If
...
```bash
python3 -m edge.facial_recognition.src.pipelines.run_both --camera /dev/video2 --no-display
```
