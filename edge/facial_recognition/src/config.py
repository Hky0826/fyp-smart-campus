...
class AccessControlConfig(RuntimeConfig):
    ...
    min_embedding_samples: int = int(os.getenv("EDGE_ACCESS_MIN_EMBEDDING_SAMPLES", "5"))
    max_embedding_samples: int = int(os.getenv("EDGE_ACCESS_MAX_EMBEDDING_SAMPLES", "10"))
    embedding_outlier_threshold: float = float(os.getenv("EDGE_ACCESS_EMBEDDING_OUTLIER_THRESHOLD", "0.25"))
    candidate_consistency_ratio: float = float(os.getenv("EDGE_ACCESS_CANDIDATE_CONSISTENCY_RATIO", "0.8"))
