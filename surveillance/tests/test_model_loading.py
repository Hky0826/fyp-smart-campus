...
class TestModelLoading(unittest.TestCase):
    ...
    def test_default_model_path_resolution(self):
        ...
        self.assertTrue(("arcface_r50" in config.face_embedder_model_path.name or "auraface" in config.face_embedder_model_path.name or "glintr100" in config.face_embedder_model_path.name) and config.face_embedder_model_path.name.endswith(".hef"))
