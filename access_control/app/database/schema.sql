...
-- Source: edge/facial_recognition/setup_sqlite.sql; model constraint adapted for OpenCV SFace
-- =========================================================================
...
CREATE TABLE IF NOT EXISTS device_user_face_embeddings (
    ...
    model_name TEXT NOT NULL CHECK (model_name IN ('openvc_sface', 'opencv_sface')),
