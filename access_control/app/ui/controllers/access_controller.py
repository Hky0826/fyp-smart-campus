...
CAMERA_FRAME_INTERVAL_MS = int(os.getenv("ACCESS_GUI_CAMERA_FRAME_INTERVAL_MS", str(round(1000 / max(1, int(os.getenv("ACCESS_DISPLAY_FPS", "24")))))))
ACCESS_RESULT_HOLD_MS = int(os.getenv("ACCESS_GUI_ACCESS_RESULT_HOLD_MS", "4000"))
CHAT_VERIFY_RETRY_MS = int(os.getenv("ACCESS_GUI_CHAT_VERIFY_RETRY_MS", "350"))
