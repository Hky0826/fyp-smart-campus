...
from ...audio_io.recorder import AudioRecorder

from .api_client import KioskApiClient


logger = logging.getLogger(__name__)
VOICE_RECORDING_MS = int(os.getenv("ACCESS_GUI_VOICE_RECORDING_MS", "4000"))
VOICE_RESTART_DELAY_MS = int(os.getenv("ACCESS_GUI_VOICE_RESTART_DELAY_MS", "250"))
TTS_OUTPUT_SAMPLE_RATE = int(os.getenv("ACCESS_GUI_TTS_OUTPUT_SAMPLE_RATE", "24000"))
VOICE_MIN_RECORD_SECONDS = float(os.getenv("ACCESS_GUI_VOICE_MIN_RECORD_SECONDS", "0.35"))
VOICE_SILENCE_SECONDS = float(os.getenv("ACCESS_GUI_VOICE_SILENCE_SECONDS", "0.55"))
VOICE_SILENCE_RMS = float(os.getenv("ACCESS_GUI_VOICE_SILENCE_RMS", "700"))
MIN_AUDIO_RMS = float(os.getenv("ACCESS_GUI_AUDIO_MIN_RMS", "500"))
MIN_AUDIO_PEAK = float(os.getenv("ACCESS_GUI_AUDIO_MIN_PEAK", "1500"))
MIN_VOICED_RATIO = float(os.getenv("ACCESS_GUI_AUDIO_MIN_VOICED_RATIO", "0.03"))
VOICE_BLOCK_MS = int(os.getenv("ACCESS_GUI_AUDIO_VOICE_BLOCK_MS", "100"))
